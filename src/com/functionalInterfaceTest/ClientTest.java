...
public class ClientTest {
	...
	private static void createThreadUsingLambdaExpression() {
		...
		// What Lambda expression says : u don't need to write and FunctionalInterface
		// has only 1 abstract method
		// for this lambda expression, it will not generate any extra .class file but
		// for anonymous class .class file will be generated
		 ...
		 * 
		 * @Override public void run() { System.out.println("My task is executing...");
		 * } };
		 */
	...
	private static void createThreadUsingAnonymousClass() {
		// Runnable is an interface and We might create a separate class which
		// implements Runnable interface
		// and u can create Runnable object. And Runnable object u can pass to the
		// Thread constructor and finally u can run the thread
		...
		// The above code is very huge and we can convert the about code into Lambda
		// expression
